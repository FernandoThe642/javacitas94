...
a persistence unit "javacitas94PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "javacitas94/pom.xml":
...
artifact ("javacitas94.war") is already built. You can build
